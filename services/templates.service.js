const userVerificationTemplate = (name, verificationLink) => {
  return {
...
const userPasswordResetTemplate = (name, resetLink) => {
  return {
...
export { userVerificationTemplate, userPasswordResetTemplate };
